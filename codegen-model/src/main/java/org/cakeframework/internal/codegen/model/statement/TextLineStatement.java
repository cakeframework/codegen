 ...
 */
public class TextLineStatement extends Statement {

    /** The comment. */
    private String comment;

    public TextLineStatement() {}

    public TextLineStatement(String comment) {
    ...
    public boolean equals(Object other) {
        return other instanceof TextLineStatement && equals((TextLineStatement) other);
    }

    public boolean equals(TextLineStatement other) {
        return super.equals(this) && Objects.equals(comment, other.comment);
    }
