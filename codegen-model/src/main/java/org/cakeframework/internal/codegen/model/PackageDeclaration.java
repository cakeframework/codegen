 ...
 */
public class PackageDeclaration extends AbstractASTNode {
    ...
    public PackageDeclaration(NameExpression name) {
        this.name = name;
    }
    ...
    public boolean equals(Object other) {
        return other instanceof PackageDeclaration && equals((PackageDeclaration) other);
    }

    public boolean equals(PackageDeclaration other) {
